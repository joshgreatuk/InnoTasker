...
namespace InnoTasker.Data
{
    public abstract class Database<TKey, TValue> : Dictionary<TKey, TValue>, IDatabase where TKey : notnull
    {
        ...
        public Database(IServiceProvider services, string path)
        {
            ...
            _logger.Log(LogSeverity.Info, this, $"Initializing database");
        ...
        public new void Add(TKey key, TValue value)
        {
            base.Add(key, value);
            Save(key);
            _logger.Log(LogSeverity.Debug, this, $"Added entry '{key}'");
        }
        ...
        public new void Remove(TKey key)
        {
            try
            {
                ...
                _logger.Log(LogSeverity.Debug, this, $"Remove entry '{key}'");
            }
            catch (Exception ex)
            {
                _logger.Log(LogSeverity.Error, this, $"Failed to remove entry '{key}'", ex);
            }
        }

        public void Save()
        {
            _logger.Log(LogSeverity.Info, this, $"Starting database save");
            int failCount = 0;
        ...
        public bool Save(TKey key)
        {
            ...
            {
                _logger.Log(LogSeverity.Error, this, $"Failed to save entry {key}", ex);
                return false;
            }
            return true;
        }
